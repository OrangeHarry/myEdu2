...
public class VariableTest {
	public static void main(String[] args) {
		...
		double realNum;// 실수(double)값을 저장하는 realNum 변수의 선언

//		System.out.println("int age value is ["+age+"]");// 초기화 해놓지 않으면 값이 출력되지 않는다.
//		System.out.println("double realNum value is ["+realNum+"]");//초기화 해놓지 않으면 값이 출력되지않는다
...
//		4.자바 예약어 사용금지(ex: void, new, private, boolean 등)
		...
		// 리터널이란??
		// 소스 코드내에서 직접 입력된 값을 리터널(literal)이라고 부른다.
	}
}
